            ...
            {size(addresses) === 0 ? (
                ...
                <Grid>
                    {map(addresses, (address) => (
                        <Grid.Column key={address.id} mobile={16} tablet={9} computer={4} >
                        <Address address={address} addressActive={addressActive} setAddressActive={setAddressActive}
...
function Address(props){
    ...
    return (
        ...
        >
            ...
            No.  de contacto: <p>{address.phone}</p>
        </div>
    )
}
